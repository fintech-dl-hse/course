...
| optimization             | 2                 |      03.03 23:59 (до конца блока CV)    |
| batchnorm                | 1                 |      03.03 23:59 (до конца блока CV)    |
| dropout                  | 1                 |      03.03 23:59 (до конца блока CV)    |
| pytorch-basics           | 2                 |      03.03 23:59 (до конца блока CV)    |
...
$$ O_{hse} = \frac{1}{24} \sum_{i} O_{hw_i} $$
...
| 27.01 | Функции активации. Задачи и функции потерь. Инициализация весов. | weight-init, activations         |
