...
* Больше 8 баллов за домашки даже с учетом бонусных баллов получить нельзя.
* Бонусными домашками нельзя закрыть баллы за экзамен.
...
| 18.05 | Evaluation. Test time scaling: majority voting, CoT. DPO, PPO, GRPO.. (Seminar: + vllm, PEFT) | efficiency          |
