...
1) Каждый шаг - генерируем новый токен
2) И каждый новый токен зависит от всех предыдущих
...
Квадратичеые вычисления - это очень плохо, поэтому
...
Это много, но посмотрите на скорость генерации. С KV-Cache скорость генерации выше на 2-3 порядка.
